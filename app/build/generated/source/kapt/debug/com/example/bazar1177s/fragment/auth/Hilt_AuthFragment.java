 ...
 */
public abstract class Hilt_AuthFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AuthFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AuthFragment_GeneratedInjector) this.generatedComponent()).injectAuthFragment(UnsafeCasts.<AuthFragment>unsafeCast(this));
    }
  }
