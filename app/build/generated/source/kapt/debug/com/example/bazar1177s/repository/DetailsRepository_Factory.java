...
public final class DetailsRepository_Factory implements Factory<DetailsRepository> {
  ...
  public static DetailsRepository_Factory create(Provider<ProductService> productServiceProvider,
      Provider<ProductDao> productDaoProvider) {
    return new DetailsRepository_Factory(productServiceProvider, productDaoProvider);
  }

  public static DetailsRepository newInstance(ProductService productService,
      ProductDao productDao) {
    return new DetailsRepository(productService, productDao);
  }
}
