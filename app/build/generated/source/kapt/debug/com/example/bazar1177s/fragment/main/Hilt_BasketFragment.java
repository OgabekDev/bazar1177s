 ...
 */
public abstract class Hilt_BasketFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BasketFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BasketFragment_GeneratedInjector) this.generatedComponent()).injectBasketFragment(UnsafeCasts.<BasketFragment>unsafeCast(this));
    }
  }
