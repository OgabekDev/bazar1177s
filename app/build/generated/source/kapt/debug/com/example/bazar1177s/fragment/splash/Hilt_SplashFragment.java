 ...
 */
public abstract class Hilt_SplashFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplashFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SplashFragment_GeneratedInjector) this.generatedComponent()).injectSplashFragment(UnsafeCasts.<SplashFragment>unsafeCast(this));
    }
  }
